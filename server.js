...
await sql`UPDATE files SET status='NEW' WHERE status='ANALYZING'`;
await sql`UPDATE files SET status='ANALYZED' WHERE status='HASHING'`;
await sql`UPDATE files SET status='HASHED' WHERE status='LOADING'`;
